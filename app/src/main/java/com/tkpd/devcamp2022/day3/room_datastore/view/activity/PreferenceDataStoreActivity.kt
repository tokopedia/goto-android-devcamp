...
import com.tkpd.devcamp2022.day3.room_datastore.view.fragment.PreferenceDataStoreFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null){
            supportFragmentManager.beginTransaction()
                .replace(R.id.local_data_parent_view, PreferenceDataStoreFragment())
                .commit()
        }
    }
}