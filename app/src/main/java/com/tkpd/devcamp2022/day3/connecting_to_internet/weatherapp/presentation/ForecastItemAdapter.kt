...
class ForecastItemAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var listForecast = mutableListOf<ForecastResponse.ListItem>()
    ...
    fun addList(item: ForecastResponse.ListItem) {
